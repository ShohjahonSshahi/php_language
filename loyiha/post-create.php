...
require 'database.php'; // $pdo shu faylda aniqlangan bo'lishi kerak

if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    // Ma'lumotlarni olish va trim() qilish (ortiqcha bo'shliqlarni olib tashlash)
    ...
    if (!empty($title) && !empty($body)) {
        try {
            ...
            exit; // Redirectdan keyin scriptni to'xtatish
        } catch (PDOException $e) {
            die("Ma'lumotni kiritishda xatolik: " . $e->getMessage());
        }
    } else {
